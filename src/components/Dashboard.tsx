      ...
      {!smsConfig || !smsConfig.enabled ? (
        <div className="bg-gradient-to-r from-yellow-50 to-orange-50 border border-yellow-200 rounded-xl p-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-yellow-900">SMS Notifications Disabled</h3>
            ...
            <button
              ...
              className="bg-yellow-600 text-white px-4 py-2 rounded-lg hover:bg-yellow-700 transition-colors duration-200 font-medium text-sm"
            >
              Setup SMS
            </button>
          </div>
        ...
        <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-green-800 font-medium text-sm">SMS Notifications Active</span>
